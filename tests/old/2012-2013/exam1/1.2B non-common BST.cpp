/* Funkcja scala 2 drzewa BST tak, ze drzewo wynikowe zawiera tylko elementy znajdujace sie na wejsciu albo w jednym, albo drugim drzewie. */
...
listNode* merge_lists (listNode* list1, listNode* list2, int &length)
{
    ...
    while (ptr1!=NULL && ptr2!=NULL)
    {
        ...
        else if (ptr1->Node->val > ptr2->Node->val)
        {
            ptr3->next=ptr2;
            ptr2=ptr2->next;
            ptr3=ptr3->next;
        ...
        {
            tmp=ptr1; ptr1=ptr1->next; delete tmp;
