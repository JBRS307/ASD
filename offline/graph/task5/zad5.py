...
#3. Z wykorzystaniem listy sąsiadów odpalamy na grafie algorytm dijkstry z punktu a. Jeśli b zostało przetworzone, to przerywamy
#algorytm i zwracamy dystans do b. Jeśli pętla while zakończy się algorytm zwróci None, bo to oznacza, że nie natrafiliśmy na b.
